...
Create a XML file called `awareness` and place it in the same folder as `resumaker.jar`. +
...
<awareness>
  ...
  <mapping>
   ...
   <context-entry eventName="hack">
     <entry category="education">
        <entryInfo title="NUS Overseas College" subheader="Assistant CEO - Helped secure funding for an IoT startup." duration="2011 Semester "/>
